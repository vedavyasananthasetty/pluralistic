    ...
    {/* <div className='container mx-auto px-4 py-6 flex items-center justify-between'>
        ...
        <ul className='flex items-center justify-center font-semibold'>
            ...
            <li  className='relative px-3 py-2 group'>
                ...
                >About-Us</button>
                <div className='absolute top-0 -left-48 transition group-hover:translate-y-5 translate-y-0 opacity-0 invisible group-hover:opacity-100 group-hover:visible duration-500 ease-in-out group-hover:transform z-50 min-w-[560px] transform bg-white'>
...
<a href='#' className='rounded-full px-3 py-2 font-semibold bg-white bg-opacity-10 flex items-center group'>
  ...
  " width="10" height="10" strokeWidth="2" viewBox="0 0 10 10" aria-hidden="true">
  <g fillRule="evenodd">
    
      <path className="opacity-0 group-hover:opacity-100 transition ease-in-out duration-200" d="M0 5h7"></path>
      <path className="opacity-100  group-hover:transform group-hover:translate-x-1 ease-in-out duration-200" d="M1 1l4 4-4 4"></path>
